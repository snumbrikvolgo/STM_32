...
Idx Name              Size      VMA       LMA       File off  Algn  Flags
  ...
  1 .text             0000142c  080000c0  080000c0  000100c0  2**2  CONTENTS, ALLOC, LOAD, READONLY, CODE
  2 .rodata           00000004  080014ec  080014ec  000114ec  2**2  CONTENTS, ALLOC, LOAD, READONLY, DATA
  3 .ARM              00000008  080014f0  080014f0  000114f0  2**2  CONTENTS, ALLOC, LOAD, READONLY, DATA
  4 .init_array       00000008  080014f8  080014f8  000114f8  2**2  CONTENTS, ALLOC, LOAD, DATA
  5 .fini_array       00000004  08001500  08001500  00011500  2**2  CONTENTS, ALLOC, LOAD, DATA
  6 .data             00000484  20000000  08001504  00020000  2**3  CONTENTS, ALLOC, LOAD, DATA
  7 .bss              0000009c  20000488  08001988  00020488  2**3  ALLOC
  8 ._user_heap_stack 00000604  20000524  08001988  00020524  2**0  ALLOC
  9 .ARM.attributes   00000028  00000000  00000000  00020484  2**0  CONTENTS, READONLY
 10 .debug_info       0000117c  00000000  00000000  000204ac  2**0  CONTENTS, READONLY, DEBUGGING
 11 .debug_abbrev     0000039b  00000000  00000000  00021628  2**0  CONTENTS, READONLY, DEBUGGING
 12 .debug_aranges    00000170  00000000  00000000  000219c3  2**0  CONTENTS, READONLY, DEBUGGING
 13 .debug_ranges     00000150  00000000  00000000  00021b33  2**0  CONTENTS, READONLY, DEBUGGING
 14 .debug_line       000006ce  00000000  00000000  00021c83  2**0  CONTENTS, READONLY, DEBUGGING
 15 .debug_str        00000b50  00000000  00000000  00022351  2**0  CONTENTS, READONLY, DEBUGGING
 16 .comment          0000007f  00000000  00000000  00022ea1  2**0  CONTENTS, READONLY
 17 .debug_frame      000006e8  00000000  00000000  00022f20  2**2  CONTENTS, READONLY, DEBUGGING
...
080000c0 <__do_global_dtors_aux>:
 ...
 80000dc:	20000488 	.word	0x20000488
 80000e0:	00000000 	.word	0x00000000
 80000e4:	080014d4 	.word	0x080014d4
...
080000e8 <frame_dummy>:
 ...
 8000104:	080014d4 	.word	0x080014d4
...
0800034a <LoopFillZerobss>:
 ...
 8000352:	f000 ffef 	bl	8001334 <__libc_init_array>
...
0800035a <LoopForever>:
 ...
 8000364:	20000484 	.word	0x20000484
 8000368:	08001504 	.word	0x08001504
 800036c:	20000488 	.word	0x20000488
 8000370:	20000524 	.word	0x20000524
...
08000a3c <exti_finite_state_machine>:
 ...
 8000cd8:	200004c0 	.word	0x200004c0
 8000cdc:	200004a8 	.word	0x200004a8
 8000ce0:	200004c8 	.word	0x200004c8
 ...
 8000cf4:	20000051 	.word	0x20000051
 8000cf8:	200004e8 	.word	0x200004e8
 8000cfc:	200004f0 	.word	0x200004f0
...
08000dd8 <tune_finite_state_machine>:
 ...
 8000ea0:	20000052 	.word	0x20000052
...
08000f78 <main>:
 ...
 8001010:	200004fc 	.word	0x200004fc
...
08001090 <SysTick_Handler>:
 ...
 8001284:	200004a8 	.word	0x200004a8
 8001288:	200004b0 	.word	0x200004b0
 800128c:	20000048 	.word	0x20000048
 8001290:	200004b8 	.word	0x200004b8
 ...
 80012a4:	200004fc 	.word	0x200004fc
...
08001334 <__libc_init_array>:
 ...
 8001338:	4d0d      	ldr	r5, [pc, #52]	; (8001370 <__libc_init_array+0x3c>)
 800133a:	1bad      	subs	r5, r5, r6
 800133c:	10ad      	asrs	r5, r5, #2
 800133e:	d006      	beq.n	800134e <__libc_init_array+0x1a>
 8001340:	2400      	movs	r4, #0
 8001342:	00a3      	lsls	r3, r4, #2
 8001344:	58f3      	ldr	r3, [r6, r3]
 8001346:	3401      	adds	r4, #1
 8001348:	4798      	blx	r3
 800134a:	42a5      	cmp	r5, r4
 800134c:	d1f9      	bne.n	8001342 <__libc_init_array+0xe>
 800134e:	f000 f8c1 	bl	80014d4 <_init>
 8001352:	4e08      	ldr	r6, [pc, #32]	; (8001374 <__libc_init_array+0x40>)
 8001354:	4d08      	ldr	r5, [pc, #32]	; (8001378 <__libc_init_array+0x44>)
 8001356:	1bad      	subs	r5, r5, r6
 8001358:	10ad      	asrs	r5, r5, #2
 800135a:	d006      	beq.n	800136a <__libc_init_array+0x36>
 800135c:	2400      	movs	r4, #0
 800135e:	00a3      	lsls	r3, r4, #2
 8001360:	58f3      	ldr	r3, [r6, r3]
 8001362:	3401      	adds	r4, #1
 8001364:	4798      	blx	r3
 8001366:	42a5      	cmp	r5, r4
 8001368:	d1f9      	bne.n	800135e <__libc_init_array+0x2a>
 800136a:	bd70      	pop	{r4, r5, r6, pc}
 800136c:	080014f8 	.word	0x080014f8
 8001370:	080014f8 	.word	0x080014f8
 8001374:	080014f8 	.word	0x080014f8
 8001378:	08001500 	.word	0x08001500

0800137c <register_fini>:
 800137c:	4b03      	ldr	r3, [pc, #12]	; (800138c <register_fini+0x10>)
 800137e:	b510      	push	{r4, lr}
 8001380:	2b00      	cmp	r3, #0
 8001382:	d002      	beq.n	800138a <register_fini+0xe>
 8001384:	4802      	ldr	r0, [pc, #8]	; (8001390 <register_fini+0x14>)
 8001386:	f000 f805 	bl	8001394 <atexit>
...
08001394 <atexit>:
 ...
 800139e:	f000 f81f 	bl	80013e0 <__register_exitproc>
 80013a2:	bd10      	pop	{r4, pc}

080013a4 <__libc_fini_array>:
 80013a4:	b570      	push	{r4, r5, r6, lr}
 80013a6:	4b09      	ldr	r3, [pc, #36]	; (80013cc <__libc_fini_array+0x28>)
 80013a8:	4c09      	ldr	r4, [pc, #36]	; (80013d0 <__libc_fini_array+0x2c>)
 80013aa:	1ae4      	subs	r4, r4, r3
 80013ac:	10a4      	asrs	r4, r4, #2
 80013ae:	d009      	beq.n	80013c4 <__libc_fini_array+0x20>
 80013b0:	4a08      	ldr	r2, [pc, #32]	; (80013d4 <__libc_fini_array+0x30>)
 80013b2:	18a5      	adds	r5, r4, r2
 80013b4:	00ad      	lsls	r5, r5, #2
 80013b6:	18ed      	adds	r5, r5, r3
 80013b8:	682b      	ldr	r3, [r5, #0]
 80013ba:	3c01      	subs	r4, #1
 80013bc:	4798      	blx	r3
 80013be:	3d04      	subs	r5, #4
 80013c0:	2c00      	cmp	r4, #0
 80013c2:	d1f9      	bne.n	80013b8 <__libc_fini_array+0x14>
 80013c4:	f000 f88c 	bl	80014e0 <_fini>
 80013c8:	bd70      	pop	{r4, r5, r6, pc}
 80013ca:	46c0      	nop			; (mov r8, r8)
 80013cc:	08001500 	.word	0x08001500
 80013d0:	08001504 	.word	0x08001504
 80013d4:	3fffffff 	.word	0x3fffffff
...
080013e0 <__register_exitproc>:
 80013e0:	b5f0      	push	{r4, r5, r6, r7, lr}
 80013e2:	464e      	mov	r6, r9
 80013e4:	4645      	mov	r5, r8
 80013e6:	46de      	mov	lr, fp
 80013e8:	4657      	mov	r7, sl
 80013ea:	b5e0      	push	{r5, r6, r7, lr}
 80013ec:	4d36      	ldr	r5, [pc, #216]	; (80014c8 <__register_exitproc+0xe8>)
 80013ee:	b083      	sub	sp, #12
 80013f0:	0006      	movs	r6, r0
 80013f2:	6828      	ldr	r0, [r5, #0]
 80013f4:	4698      	mov	r8, r3
 80013f6:	000f      	movs	r7, r1
 80013f8:	4691      	mov	r9, r2
 80013fa:	f7ff ffed 	bl	80013d8 <__retarget_lock_acquire_recursive>
 80013fe:	4b33      	ldr	r3, [pc, #204]	; (80014cc <__register_exitproc+0xec>)
 8001400:	681c      	ldr	r4, [r3, #0]
 8001402:	23a4      	movs	r3, #164	; 0xa4
 8001404:	005b      	lsls	r3, r3, #1
 8001406:	58e0      	ldr	r0, [r4, r3]
 8001408:	2800      	cmp	r0, #0
 800140a:	d052      	beq.n	80014b2 <__register_exitproc+0xd2>
 800140c:	6843      	ldr	r3, [r0, #4]
 800140e:	2b1f      	cmp	r3, #31
 8001410:	dc13      	bgt.n	800143a <__register_exitproc+0x5a>
 8001412:	1c5a      	adds	r2, r3, #1
 8001414:	9201      	str	r2, [sp, #4]
 8001416:	2e00      	cmp	r6, #0
 8001418:	d128      	bne.n	800146c <__register_exitproc+0x8c>
 800141a:	9a01      	ldr	r2, [sp, #4]
 800141c:	3302      	adds	r3, #2
 800141e:	009b      	lsls	r3, r3, #2
 8001420:	6042      	str	r2, [r0, #4]
 8001422:	501f      	str	r7, [r3, r0]
 8001424:	6828      	ldr	r0, [r5, #0]
 8001426:	f7ff ffd9 	bl	80013dc <__retarget_lock_release_recursive>
 800142a:	2000      	movs	r0, #0
 800142c:	b003      	add	sp, #12
 800142e:	bc3c      	pop	{r2, r3, r4, r5}
 8001430:	4690      	mov	r8, r2
 8001432:	4699      	mov	r9, r3
 8001434:	46a2      	mov	sl, r4
 8001436:	46ab      	mov	fp, r5
 8001438:	bdf0      	pop	{r4, r5, r6, r7, pc}
 800143a:	4b25      	ldr	r3, [pc, #148]	; (80014d0 <__register_exitproc+0xf0>)
 800143c:	2b00      	cmp	r3, #0
 800143e:	d03d      	beq.n	80014bc <__register_exitproc+0xdc>
 8001440:	20c8      	movs	r0, #200	; 0xc8
 8001442:	0040      	lsls	r0, r0, #1
 8001444:	e000      	b.n	8001448 <__register_exitproc+0x68>
 8001446:	bf00      	nop
 8001448:	2800      	cmp	r0, #0
 800144a:	d037      	beq.n	80014bc <__register_exitproc+0xdc>
 800144c:	22a4      	movs	r2, #164	; 0xa4
 800144e:	2300      	movs	r3, #0
 8001450:	0052      	lsls	r2, r2, #1
 8001452:	58a1      	ldr	r1, [r4, r2]
 8001454:	6043      	str	r3, [r0, #4]
 8001456:	6001      	str	r1, [r0, #0]
 8001458:	50a0      	str	r0, [r4, r2]
 800145a:	3240      	adds	r2, #64	; 0x40
 800145c:	5083      	str	r3, [r0, r2]
 800145e:	3204      	adds	r2, #4
 8001460:	5083      	str	r3, [r0, r2]
 8001462:	3301      	adds	r3, #1
 8001464:	9301      	str	r3, [sp, #4]
 8001466:	2300      	movs	r3, #0
 8001468:	2e00      	cmp	r6, #0
 800146a:	d0d6      	beq.n	800141a <__register_exitproc+0x3a>
 800146c:	009a      	lsls	r2, r3, #2
 800146e:	4692      	mov	sl, r2
 8001470:	4482      	add	sl, r0
 8001472:	464a      	mov	r2, r9
 8001474:	2188      	movs	r1, #136	; 0x88
 8001476:	4654      	mov	r4, sl
 8001478:	5062      	str	r2, [r4, r1]
 800147a:	22c4      	movs	r2, #196	; 0xc4
 800147c:	0052      	lsls	r2, r2, #1
 800147e:	4691      	mov	r9, r2
 8001480:	4481      	add	r9, r0
 8001482:	464a      	mov	r2, r9
 8001484:	3987      	subs	r1, #135	; 0x87
 ...
 800149c:	50a1      	str	r1, [r4, r2]
 800149e:	2e02      	cmp	r6, #2
 80014a0:	d1bb      	bne.n	800141a <__register_exitproc+0x3a>
 80014a2:	0002      	movs	r2, r0
 80014a4:	465c      	mov	r4, fp
 80014a6:	328d      	adds	r2, #141	; 0x8d
 80014a8:	32ff      	adds	r2, #255	; 0xff
 80014aa:	6811      	ldr	r1, [r2, #0]
 80014ac:	430c      	orrs	r4, r1
 80014ae:	6014      	str	r4, [r2, #0]
 80014b0:	e7b3      	b.n	800141a <__register_exitproc+0x3a>
 80014b2:	0020      	movs	r0, r4
 80014b4:	304d      	adds	r0, #77	; 0x4d
 80014b6:	30ff      	adds	r0, #255	; 0xff
 80014b8:	50e0      	str	r0, [r4, r3]
 80014ba:	e7a7      	b.n	800140c <__register_exitproc+0x2c>
 80014bc:	6828      	ldr	r0, [r5, #0]
 80014be:	f7ff ff8d 	bl	80013dc <__retarget_lock_release_recursive>
 80014c2:	2001      	movs	r0, #1
 80014c4:	4240      	negs	r0, r0
 80014c6:	e7b1      	b.n	800142c <__register_exitproc+0x4c>
 80014c8:	20000480 	.word	0x20000480
 80014cc:	080014ec 	.word	0x080014ec
